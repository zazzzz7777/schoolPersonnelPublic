				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="宿舍号" prop="sushehao">
							<el-input class="list_inp" v-model="form.sushehao" placeholder="宿舍号"
								 type="text" 								:readonly="!isAdd||disabledForm.sushehao?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='sushehao'){
					form.value.sushehao = row[x];
					disabledForm.value.sushehao = true;
					continue;
				}
				if(x=='lianxifangshi'){
